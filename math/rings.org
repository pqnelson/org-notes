...
#+NAME: defn-ideal
#+ATTR_HTML: :id h-ecfbd034-a50a-473e-b41d-5f2e9b95b1aa
#+begin_definition
Let $R$ be a ring.
...
#+ATTR_HTML: :id h-8651e942-751b-48c8-91cf-e4e4efde3ce6
#+begin_definition
...
#+NAME: defn-gcd
#+ATTR_HTML: :id h-95278a20-54ec-4f4a-8784-e1c52bb9ab87
#+begin_definition
...
such that $z=ut$.
#+end_lemma
#+ATTR_HTML: :id h-03500842-73d7-4483-8157-4e5272765cec
#+begin_proof
...
#+ATTR_HTML: :id h-ac464947-de1c-49bd-a717-e06a56f0d71b
#+begin_proof
- Assume $z = \gcd(x,y)$, $t=\gcd(x,y)$, and $t\neq z$.
...
#+ATTR_HTML: :id h-055d8fbf-a87f-443a-bd76-613c3449c526
#+begin_proof
- Let $p\in R$ be prime.
