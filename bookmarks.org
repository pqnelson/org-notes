...
- John N. Bray, Yegor Stepanov, Robert A. Wilson,\\
  "Octonions, Albert vectors and the group 2E6(F)".\\
  {{{arXiv(2609.23109)}}}, 28 pages
...
- Mario Carneiro,\\
  "CIC + EM ⊢ Con(ZF): the consistency of ZF in type theory with excluded middle and no choice".\\
  {{{arXiv(2609.23143)}}}, 13 pages.
