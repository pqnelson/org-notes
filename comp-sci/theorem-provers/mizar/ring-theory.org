...
are defined in the "ring theory wing" of the Mizar
library. *Addendum:* a better "Rosetta stone" may be found [[file:rings.org][here]]...go
there instead. (I've removed this from the table of contents, but I'm
keeping this file around for archival purposes.)
