...
to be the first one using dependently-typed lambda calculus. A proof
script for Automath is called a "Book", its statements are called "Lines".
...
- N.G. de Bruijn,\\
  ...
  extensions".\\
  [[https://www.win.tue.nl/automath/archive/webversion/aut002/aut002.html][Eprint]], dated December 1968
- N.G. de Bruijn,\\
