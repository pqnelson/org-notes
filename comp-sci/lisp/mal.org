...
- Guy Steele, Jr.,
  ...
  Second ed.
- R. Brooks, R. Gabriel, G. Steele,
  "Lisp-in-Lisp: High Performance and Portability".
  [[https://www.dreamsongs.com/Files/ijs1.pdf][PDF]].
- R. Brooks, R. Gabriel, G. Steele,
  "S-1 Common Lisp Implementation".
  [[https://citeseerx.ist.psu.edu/viewdoc/download?doi=10.1.1.572.8410&rep=rep1&type=pdf][PDF]].

** Exploratory Implementations

- [[https://github.com/JeffBezanson/femtolisp][Femtolisp]]
- [[https://taoofmac.com/space/dev/lisp][Obscure implementations]]
- [[https://notes.eatonphil.com/compiler-basics-lisp-to-assembly.html][Writing a lisp compiler from scratch in JavaScript: 1. lisp to assembly]]
-
