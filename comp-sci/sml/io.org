...
#+begin_remark
Perhaps I am wildly optimistic and/or ignorant here. For example, there
may be some impurity in concurrent programming that I am unaware
of...
#+end_remark

I also do not believe there is any adequate way to reason about IO. The
naive solution is to treat Standard ML's streams like a stack of strings
(possibly with metadata like timestamps). But this is inadequate for
concurrent systems.
